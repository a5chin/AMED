...
\clearpage
    ...
    \section{前回のLTからの進捗}
        \begin{itemize}
            ...
            \begin{figure}[h]
                \centering
                \subfloat[実験で使用するSimSiam\cite{simsiam}とCenterNet\cite{centernet}の複合モデル概要]{\includegraphics[width=.54\linewidth]{../fig/models.pdf} \label{fig:models}}
                \subfloat[backboneの重みを全て固定したモデルでの混同行列]{\includegraphics[width=.44\linewidth]{../fig/heatmap_centernet_fix.pdf} \label{fig:heatmap_model_fix}}
