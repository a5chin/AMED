...
def test5():
    df = {"file_name": "007234.jpg", "preds": [0], "reliability": [0.0], "bbox": [[]], "label": [3], "iou": [0.0]}
...
def test6():
    df = {
        ...
        "label": [1],
        "iou": [0.7789446711540222, 0.7789446711540222],
    }
